...
from Data.LoginClassData import TokenData, User
from component.Login.LoginCONTENT import pwd_context, SECRET_KEY, ALGORITHM, oauth2_scheme
...
def get_user(username: str) -> User:
    sql = f"select id, user_name, user_email, wx_open_id, password from apply_user where user_name='{username}'"
